...
class LTCMembershipCategory extends Model
{
    CONST MODEL_NAME='Categoria: Centro de Ensino e Línguas - Inscrições para o Clube de Leitura';
     ...
     * @var string
     */
    protected $table = 'website_cel_cats';
