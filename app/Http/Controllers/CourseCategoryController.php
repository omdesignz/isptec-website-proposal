...
class CourseCategoryController extends Controller
{
    ...
    {
        $category = CourseCategory::withTrashed()->findOrFail($id)->setLocale($request->lang);

        return view('admin.coursecategory.lang', [
            'lang' => $request->lang,
            'category' => [
                'id' => $category->id,
                'name' => $category->name,
    ...
    public function settranslation(Request $request, $id)
    {
        ...
        return redirect()->route('coursecategories.index')->with('notification',[
