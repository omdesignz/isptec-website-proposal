...
class MediaCategoryController extends Controller
{
    ...
    {   
        return view('admin.mediacategory.index', [
    ...
    {
        return view('admin.mediacategory.create');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $category = MediaCategory::withTrashed()->findOrFail($id);

        return view('admin.mediacategory.show', [
            'category' => [
                'id' => $category->id,
                'name' => $category->name,
    ...
    {
        $category = MediaCategory::withTrashed()->findOrFail($id)->setLocale($request->lang);

        return view('admin.mediacategory.lang', [
            'lang' => $request->lang,
            'category' => [
                'id' => $category->id,
                'name' => $category->name,
    ...
    public function settranslation(Request $request, $id)
    {
        ...
        return redirect()->route('mediacategories.index')->with('notification',[
