...
class JournalCategoryController extends Controller
{
    ...
    {   
        return view('admin.journalcategory.index', [
    ...
    {
        return view('admin.journalcategory.create');
    }
    ...
    {
        $category = JournalCategory::find($id);

        $category = JournalCategory::withTrashed()->findOrFail($id);

        return view('admin.journalcategory.show', [
            'category' => [
                'id' => $category->id,
                'name' => $category->name,
    ...
    {
        $category = JournalCategory::withTrashed()->findOrFail($id)->setLocale($request->lang);

        return view('admin.journalcategory.lang', [
            'lang' => $request->lang,
            'category' => [
                'id' => $category->id,
                'name' => $category->name,
    ...
    public function settranslation(Request $request, $id)
    {
        ...
        return redirect()->route('journalcategories.index')->with('notification',[
