...
class AcademicCategoryController extends Controller
{
    ...
    {   
        return view('admin.academiccategory.index', [
    ...
    {
        return view('admin.academiccategory.create');
    }
    ...
    {
        $category = AcademicCategory::find($id);

        $category = AcademicCategory::withTrashed()->findOrFail($id);

        return view('admin.academiccategory.show', [
            'category' => [
                'id' => $category->id,
                'name' => $category->name,
    ...
    {
        $category = AcademicCategory::withTrashed()->findOrFail($id)->setLocale($request->lang);

        return view('admin.academiccategory.lang', [
            'lang' => $request->lang,
            'category' => [
                'id' => $category->id,
                'name' => $category->name,
    ...
    public function settranslation(Request $request, $id)
    {
        ...
        return redirect()->route('academiccategories.index')->with('notification',[
