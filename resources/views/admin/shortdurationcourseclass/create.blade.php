...
<div class="px-4 sm:px-6 lg:px-8 mt-8">
    ...
    <form method="post" action="{{ route('shortdurationcourseclasses.store') }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data" x-data="imgPreview" x-cloak> 
        @csrf  
        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
          ...
          <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="total_hours" id="total_hours" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('total_hours')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="price" id="price" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('price')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
                    @if($errors->has('price'))
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="registration_fee" id="registration_fee" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('registration_fee')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                  <textarea id="extra_data" name="extra_data" rows="4" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('extra_data')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm"></textarea>
                    </div>
