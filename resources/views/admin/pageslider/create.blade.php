...
<div class="px-4 sm:px-6 lg:px-8 mt-8">
    ...
    <form method="post" action="{{ route('pagesliders.store') }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data" x-data="imgPreview" x-cloak> 
        @csrf  
        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl class="sm:divide-y sm:divide-gray-200">
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="width" id="width" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('width')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
                    @if($errors->has('width'))
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="height" id="height" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('height')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="interval" id="interval" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('interval')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="description" id="description" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('description')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
                        ...
                        <li class="py-4">
                          <div class="flex items-center space-x-4">
                            <div class="flex h-44 w-96 rounded-md items-center justify-center">
                              ...
                              <template x-if="image.image">
                                <a href="#" @click.prevent="document.getElementById(`image[${index}][image]`).click()">
                                <img :src="image.image" class="object-cover h-96 w-96 rounded-2xl">
                              </a>
                              </template>
                            ...
                            <div class="flex-1 min-w-0">
                              {{-- <h2> --}}
                                <div>
                                  ...
                                  <div class="mt-1">
                                    <input type="text" :name="`image[${index}][title]`" :id="`image[${index}][title]`" class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-md px-2.5 py-1.5 text-xs font-medium" placeholder="">
                                  </div>
                              ...
                              <p class="text-sm font-medium text-gray-900 truncate">
                                <div>
                                  ...
                                  <div class="mt-1">
                                    <input type="url" :name="`image[${index}][link]`" :id="`image[${index}][link]`" class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-md px-2.5 py-1.5 text-xs font-medium" placeholder="">
                                  </div>
                                </div>
                              </p>
                              ...
                              <p class="mt-1 text-xs text-gray-500">
                                <div>
                                  ...
                                  <div class="mt-1">
                                    <textarea rows="4" :name="`image[${index}][description]`" :id="`image[${index}][description]`" class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-md px-2.5 py-1.5 text-xs font-medium" placeholder=""></textarea>
                                  </div>
                                </div>
                              </p>
                            </div>
