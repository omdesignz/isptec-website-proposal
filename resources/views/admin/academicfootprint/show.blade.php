...
<div class="px-4 sm:px-6 lg:px-8 mt-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        {{-- <p class="mt-2 text-sm text-gray-700">A visualizar o tópico <strong class="font-semibold text-gray-900">{{$footprint['name']}}</strong>.</p> --}}
      </div>
