    ...
    <div class="fixed inset-0 overflow-hidden">
      <div class="absolute inset-0 overflow-hidden">
        <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
          ...
          >
            <form class="flex h-full flex-col divide-y divide-gray-200 bg-white shadow-xl" action="/admin/settings" method="POST">
              @csrf
              <div class="h-0 flex-1 overflow-y-auto">
                <div class="bg-yellow-400 py-6 px-4 sm:px-6">
                  <div class="flex items-center justify-between">
                    <h2 class="text-lg font-medium text-gray-900" id="slide-over-title">Novo Parâmetro</h2>
                ...
                <div class="flex flex-1 flex-col justify-between">
                  <div class="divide-y divide-gray-200 px-4 sm:px-6">
                    <div class="space-y-6 pt-6 pb-5">
                      <div>
                        <label for="option" class="block text-sm font-medium text-gray-900"> Parâmetro </label>
                        <div class="mt-1">
                          <input type="text" name="option" id="option" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('option')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                        </div>
                      ...
                      <div>
                        ...
                        <div class="mt-1">
                          <textarea id="value" name="value" rows="4" class="block w-full rounded-md border border-gray-300 shadow-sm focus:border-rose-500 focus:ring-rose-500 sm:text-sm"></textarea>
                        </div>
                        @if($errors->has('value'))
