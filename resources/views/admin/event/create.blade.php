...
<div class="px-4 sm:px-6 lg:px-8 mt-8">
    ...
    <form method="post" action="{{ route('events.store') }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data" x-data="imgPreview" x-cloak> 
        @csrf  
        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl class="sm:divide-y sm:divide-gray-200">
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="url" name="link" id="link" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('link')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
                    @if($errors->has('link'))
          ...
          <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <div class="mt-1">
                      <input value="" type="text" name="venue" id="venue" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('venue')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                      </div>
                      @if($errors->has('venue'))
                        ...
                        <li class="py-4">
                          <div class="flex items-center space-x-4">
                            <div class="flex h-44 w-72 rounded-full bg-yellow-400 items-center justify-center">
                              ...
                              <template x-if="speaker.avatar">
                                <a href="#" @click.prevent="document.getElementById(`speaker[${index}][avatar]`).click()">
                                <img :src="speaker.avatar" class="object-cover h-96 w-96 rounded-2xl">
                              </a>
                              </template>
                              <input class="cursor-pointer absolute hidden opacity-0 pin-r pin-t"
                            ...
                            <div class="flex-1 min-w-0">
                              {{-- <h2> --}}
                                <div>
                                  ...
                                  <div class="mt-1">
                                    <input type="text" :name="`speaker[${index}][full_name]`" :id="`speaker[${index}][full_name]`" class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-md px-2.5 py-1.5 text-xs font-medium" placeholder="">
                                  </div>
                              ...
                              <p class="text-sm font-medium text-gray-900 truncate">
                                <div>
                                  ...
                                  <div class="mt-1">
                                    <input type="text" :name="`speaker[${index}][topic]`" :id="`speaker[${index}][topic]`" class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-md px-2.5 py-1.5 text-xs font-medium" placeholder="">
                                  </div>
                                </div>
                              </p>
                              <p class="mt-1 text-xs text-gray-500">
                                <div>
                                  ...
                                  <div class="mt-1">
                                    <input type="text" :name="`speaker[${index}][contact]`" :id="`speaker[${index}][contact]`" class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-md px-2.5 py-1.5 text-xs font-medium" placeholder="">
                                  </div>
                                </div>
                              </p>
                              <p class="mt-1 text-xs text-gray-500">
                                <div>
                                  ...
                                  <div class="mt-1">
                                    <textarea rows="4" :name="`speaker[${index}][bio]`" :id="`speaker[${index}][bio]`" class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-md px-2.5 py-1.5 text-xs font-medium" placeholder=""></textarea>
                                  </div>
                                </div>
                              </p>
                            </div>
