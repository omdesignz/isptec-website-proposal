...
<div class="px-4 sm:px-6 lg:px-8 mt-8">
    ...
    <form method="post" action="{{ route('employees.store') }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data" x-data="imgPreview" x-cloak> 
        @csrf  
        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl class="sm:divide-y sm:divide-gray-200">
                  ...
                  <fieldset class="">
                    ...
                    <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                      <div class="flex items-center">
                        <input value="M" id="male" name="gender" type="radio" checked class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
                        <label for="male" class="ml-3 block text-sm font-medium text-gray-700">Masculino</label>
                      </div>
                
                      <div class="flex items-center">
                        <input value="F" id="female" name="gender" type="radio" class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="full_name" id="full_name" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('full_name')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="tel_no" id="tel_no" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('tel_no')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="number" name="extension" id="extension" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('extension')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="orcid_id" id="orcid_id" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('orcid_id')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
              <div class="mt-1">
                <fieldset class="">
                  ...
                  <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                    <div class="flex items-center">
                      <input value="1" id="yes" name="is_national" type="radio" checked class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
                      <label for="yes" class="ml-3 block text-sm font-medium text-gray-700">SIM</label>
                    </div>
              
                    <div class="flex items-center">
                      <input value="0" id="no" name="is_national" type="radio" class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
            ...
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
              <div class="mt-1">
                <fieldset class="">
                  ...
                  <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                    <div class="flex items-center">
                      <input value="1" id="yes" name="is_lecturer" type="radio" checked class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
                      <label for="yes" class="ml-3 block text-sm font-medium text-gray-700">SIM</label>
                    </div>
              
                    <div class="flex items-center">
                      <input value="0" id="no" name="is_lecturer" type="radio" class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
                      <label for="no" class="ml-3 block text-sm font-medium text-gray-700">NÃO</label>
                    </div>
                  </div>
                </fieldset>
            ...
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
              <div class="mt-1">
                <fieldset class="">
                  ...
                  <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                    <div class="flex items-center">
                      <input value="1" id="yes" name="receive_bday_notification" type="radio" checked class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
                      <label for="yes" class="ml-3 block text-sm font-medium text-gray-700">SIM</label>
                    </div>
              
                    <div class="flex items-center">
                      <input value="0" id="no" name="receive_bday_notification" type="radio" class="h-4 w-4 border-gray-300 text-yellow-400 focus:ring-yellow-400">
                      <label for="no" class="ml-3 block text-sm font-medium text-gray-700">NÃO</label>
                    </div>
                  </div>
                </fieldset>
