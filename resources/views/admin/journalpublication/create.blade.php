...
<div class="px-4 sm:px-6 lg:px-8 mt-8">
    ...
    <form method="post" action="{{ route('journalpublications.store') }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data" x-data="imgPreview" x-cloak> 
        @csrf  
        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl class="sm:divide-y sm:divide-gray-200">
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="journal_name" id="journal_name" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('journal_name')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="title" id="title" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('title')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
                    @if($errors->has('title'))
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="authors" id="authors" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('authors')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="url" name="external_url" id="external_url" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('external_url')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="reference" id="reference" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('reference')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                    <input value="" type="text" name="lecturers" id="lecturers" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('lecturers')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm">
                    </div>
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div class="mt-1">
                  <textarea id="summary" name="summary" rows="4" class="block w-full rounded-md border-gray-300 shadow-sm @if($errors->has('summary')) focus:border-rose-500 focus:ring-rose-500 @endif sm:text-sm"></textarea>
                    </div>
