...
<div class="relative z-40 lg:hidden" role="dialog" aria-modal="true" x-show="openSidebar"
    ...
    <div class="fixed inset-0 flex z-40">
      <!--
        ...
        Leaving: "transition ease-in-out duration-300 transform"
          ...
          To: "-translate-x-full"
      -->
      <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gradient-to-r from-yellow-500 to-yellow-400">
        <!--
        ...
        <div class="absolute top-0 right-0 -mr-12 pt-2">
          <button @click="openSidebar = false" type="button" class="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
        ...
        <nav class="mt-5 flex-shrink-0 h-full divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
          <div class="px-2 space-y-1">
            ...
            <div class="space-y-1" x-data="{ sidebarMenuOpen: false}">
              <!-- Current: "bg-gray-100 text-gray-900", Default: "bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900" -->
              <button @click="sidebarMenuOpen = !sidebarMenuOpen" type="button" class="text-gray-600 hover:bg-yellow-300 hover:text-gray-700 group w-full flex items-center pl-2 pr-1 py-2 text-left text-sm font-medium rounded-md focus:outline-none aria-controls="sub-menu-1" aria-expanded="false">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="sidebarMenuOpen ? 'text-gray-700 rotate-90' : ''" class="text-gray-600 ml-3 h-5 w-5 flex-shrink-0 transform transition-colors duration-150 ease-in-out group-hover:text-gray-400">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                </svg>              
              </button>
              <!-- Expandable link section, show/hide based on state. -->
              <div class="space-y-1" id="sub-menu-1" x-show="sidebarMenuOpen"
