...
<div class="min-h-full"
            ...
            >
    @include('layouts.includes.backend._mobile_navigation')
    @include('layouts.includes.backend._navigation')
  
    <div class="lg:pl-64 flex flex-col flex-1">
      <div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none">
        <button @click="openSidebar = true" type="button" class="px-4 border-r border-gray-200 text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-500 lg:hidden">
        ...
        <!-- Search bar -->
        @include('layouts.includes.backend._search')
      </div>
      <main class="flex-1 pb-8">
        {{-- @include('layouts.includes.backend._user_header') --}}
        {{-- @include('layouts.includes.backend._dashboard_grid') --}}
        @yield('content')
        {{-- <div class="mt-8">
  ...
  @if (session('notification'))
    @include('layouts.includes.backend._notification')
  @endif
