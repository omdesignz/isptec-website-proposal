...
<div class="relative bg-white py-16 sm:py-8">
    ...
    <div class="relative sm:py-16 lg:py-0">
      ...
      <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
        ...
        <div class="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
          <img class="absolute inset-0 h-full w-full object-cover" src="{{ asset('/campaign/2P7A2143.jpg') }}" alt="" loading="lazy"/>
          <!-- <div class="absolute inset-0 bg-isptec mix-blend-multiply"></div> -->
          <!-- <div class="absolute inset-0 bg-gradient-to-t from-yellow-600 via-isptec opacity-90"></div> -->
      ...
      <div class="mt-10">
        <dl class="grid grid-cols-2 gap-x-4 gap-y-8">
          <div class="border-t-2 border-gray-100 pt-6">
            <dt class="text-base font-medium text-gray-500">Partilhar</dt>
            <dd class="text-3xl inline-flex space-x-2 font-extrabold tracking-tight text-gray-900">
            <a href="#" class="text-gray-400 hover:text-isptec transform transition-all duration-200 hover:scale-150">
            ...
            <a href="#" class="text-gray-400 hover:text-isptec transform transition-all duration-200 hover:scale-150">
                ...
                <svg role="img" viewBox="0 0 24 24" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="#" class="text-gray-400 hover:text-isptec transform transition-all duration-200 hover:scale-150">
                ...
                <svg role="img" viewBox="0 0 24 24" class="h-6 w-6" fill="currentColor">
